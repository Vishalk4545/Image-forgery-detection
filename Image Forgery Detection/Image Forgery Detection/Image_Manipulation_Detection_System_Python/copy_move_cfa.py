# import some  main lib need during execution
...
#distance beetween two points using encludean formula
def Dist(p1, p2):
    x1, y1 = p1
    x2, y2 = p2
...
#to check same cluster beetween two points
...
#image details like block size by using above values
...
#image convert into custom colors
...
#divide imaage into paets and matched it
...
#by using zip image will bge compressed and feature are extracted
...
#to matched image part together
